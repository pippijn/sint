...
*   [x] **Full Loop:** Client <-> Server <-> AI synchronization verified (Chat & Actions).
...
*   **Tasks:**
    ...
    2.  "Ready" voting system visibility.
    *   (Completed: Connection Status Indicator, Join Game Button, Chat UI)

### **C. AI Improvement**
*   **Tasks:**
    1.  Implement `simulate_plan` tool for AI to self-validate complex moves.
    *   (Completed: Single-shot, Context-rich prompts, Robust Schema, Chat Memory, Event-Driven Architecture)
